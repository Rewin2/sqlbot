...
const faturaHook = new Webhook(ayarlar.faturalogWebhookURL);
    ...
    whitelistHook.setUsername("RuinsSQLSystem") // İstediğinizi yazabilirsiniz. 


    faturaHook.setAvatar()
    faturaHook.setUsername("RuinsSQLSystem")

module.exports = {
    logs: () => {
        
        const LogEmbed = new MessageBuilder()
        .setFooter("RuinsSQLSystem")
        ...
        if (ayarlar.whitelistlogAktif === true) {
            ...
            listener.add("essentialmode.whitelist", (oldRow,newRow,event) =>{
                if (oldRow === null) {
                    LogEmbed.setAuthor("RuinsLOG -> Whitelist Eklendi")
                    .setColor(green)
                ...
                if (newRow === null) {
                    LogEmbed.setAuthor("RuinsLOG -> Whitelist Silindi")
                    .setColor(red)
        ...
        if (ayarlar.faturalogAktif === true) {
            listener.add("essentialmode.billing",(oldRow,newRow,event) => {
                ...
                if (oldRow === null) {
                    LogEmbed.setAuthor("RuinsLOG -> Fatura Yazıldı")
                    .setColor(green)
                ...
                if (newRow === null) {
                    LogEmbed.setAuthor("RuinsLOG -> Fatura Ödendi")
                    .setColor(red)
